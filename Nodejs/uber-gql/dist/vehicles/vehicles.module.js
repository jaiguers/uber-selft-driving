...
exports.VehiclesModule = VehiclesModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([vehicle_entity_1.Vehicle]), users_module_1.UsersModule],
        providers: [vehicles_resolver_1.VehiclesResolver, vehicles_service_1.VehiclesService],
