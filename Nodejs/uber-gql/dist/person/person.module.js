...
exports.PersonModule = PersonModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([person_entity_1.Person]), users_module_1.UsersModule],
        providers: [person_resolver_1.PersonResolver, person_service_1.PersonService],
